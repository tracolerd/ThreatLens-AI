...
Note: URLs sent to the backend are evaluated transiently and are strictly not stored in any database.
Sensitive query parameters are stripped during heuristic extraction to preserve user privacy.
